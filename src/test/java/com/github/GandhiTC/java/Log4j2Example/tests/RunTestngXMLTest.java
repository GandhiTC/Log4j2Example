...
public class RunTestngXMLTest
{
	private Logger		log		= LogManager.getLogger(RunTestngXMLTest.class.getName());
	private WebDriver	driver;


	@Test
	@Parameters({ "browserName" })
	public void loggerTest(String browser)
	{
		...
		if((browser != null) && !browser.isEmpty())
		{
			...
			else
			{
				...
				if(browser.toLowerCase().contains("headless"))
				{
					...
					chromeOptions.setHeadless(true);	//	chromeOptions.addArguments("headless");
	...
	private void seLoggingtLevel(Level targetLevel)
	{
